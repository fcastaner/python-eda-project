...
Existe una correlación positiva alta entre emp.var.rate y euribor3m, lo que sugiere que ambas variables tienden a moverse en la misma dirección debido a factores económicos.
También se observa relación entre emp.var.rate y cons.price.idx, lo cual sugiere de nuevo que estas variables están igualmente influenciadas por factores económicos.
